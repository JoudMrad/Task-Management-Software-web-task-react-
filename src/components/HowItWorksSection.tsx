        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            {steps.map((step, index) => (
              ...
              >
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-7 h-7 rounded-full gradient-bg flex items-center justify-center text-primary-foreground text-xs font-bold z-10 transition-all duration-300 group-hover:scale-110 group-hover:shadow-glow">
                  {index + 1}
                </div>

                <div className="pt-6 p-6 rounded-2xl glass-card transition-all duration-300 ease-out group-hover:border-primary/40 group-hover:shadow-xl group-hover:-translate-y-2 group-hover:bg-gradient-to-b group-hover:from-card group-hover:to-primary/5">
                  <div className="w-14 h-14 rounded-2xl bg-muted flex items-center justify-center mx-auto mb-5 transition-all duration-300 group-hover:bg-primary/15 group-hover:scale-110 group-hover:rotate-3">
                    <step.icon className="w-7 h-7 text-primary transition-all duration-300 group-hover:scale-110" />
                  </div>
